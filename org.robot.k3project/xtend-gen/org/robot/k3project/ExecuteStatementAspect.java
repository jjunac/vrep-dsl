...
public class ExecuteStatementAspect extends StatementAspect {
  public static Scenario exec(final ExecuteStatement _self) {
    ...
    if (_self instanceof org.robot.model.robot.ExecuteStatement){
    	result = org.robot.k3project.ExecuteStatementAspect._privk3_exec(_self_, (org.robot.model.robot.ExecuteStatement)_self);
    };
    return (org.robot.model.robot.Scenario)result;
  }
  
  protected static Scenario _privk3_exec(final ExecuteStatementAspectExecuteStatementAspectProperties _self_, final ExecuteStatement _self) {
