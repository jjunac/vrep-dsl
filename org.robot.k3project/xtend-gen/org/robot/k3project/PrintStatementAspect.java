...
public class PrintStatementAspect extends StatementAspect {
  public static Scenario step(final PrintStatement _self) {
    ...
    if (_self instanceof org.robot.model.robot.PrintStatement){
    	result = org.robot.k3project.PrintStatementAspect._privk3_step(_self_, (org.robot.model.robot.PrintStatement)_self);
    };
    return (org.robot.model.robot.Scenario)result;
  }
  
  protected static Scenario _privk3_step(final PrintStatementAspectPrintStatementAspectProperties _self_, final PrintStatement _self) {
