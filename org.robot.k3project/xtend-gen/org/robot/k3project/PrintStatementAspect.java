...
public class PrintStatementAspect extends StatementAspect {
  public static Scenario exec(final PrintStatement _self) {
    ...
    if (_self instanceof org.robot.model.robot.PrintStatement){
    	result = org.robot.k3project.PrintStatementAspect._privk3_exec(_self_, (org.robot.model.robot.PrintStatement)_self);
    };
    return (org.robot.model.robot.Scenario)result;
  }
  
  protected static Scenario _privk3_exec(final PrintStatementAspectPrintStatementAspectProperties _self_, final PrintStatement _self) {
