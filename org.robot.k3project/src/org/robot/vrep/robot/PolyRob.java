 ...
 *******************************************************************************/
package org.robot.vrep.robot;

import java.util.ArrayList;

import org.robot.vrep.robot.utils.Blob;
import org.robot.vrep.robot.utils.Position2D;
...
public class PolyRob {
	...
	private static PolyRob singleton;
	
	public static void createSingleton(String IP, int portNumber) {
		singleton = new PolyRob(IP, portNumber);
		singleton.start();
	}
	
	public static PolyRob getSingleton() {
		return singleton;
	}
	
	private PolyRob(String IP, int portNumber) {
