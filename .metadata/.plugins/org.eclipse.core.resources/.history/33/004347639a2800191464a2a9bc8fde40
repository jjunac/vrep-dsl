 ...
 * </p>
 * <ul>
 *   <li>{@link org.robot.model.robot.impl.PrintStatementImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrintStatementImpl extends StatementImpl implements PrintStatement {
	...
	protected EClass eStaticClass() {
		return RobotPackage.Literals.PRINT_STATEMENT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobotPackage.PRINT_STATEMENT__TEXT, oldText, text));
	}
