 ...
 * </p>
 * <ul>
 *   <li>{@link org.robot.model.robot.impl.StatementBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatementBlockImpl extends MinimalEObjectImpl.Container implements StatementBlock {
	...
	protected EClass eStaticClass() {
		return RobotPackage.Literals.STATEMENT_BLOCK;
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this,
					RobotPackage.STATEMENT_BLOCK__STATEMENTS);
		}
		return statements;
	}
